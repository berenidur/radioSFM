...
for lambda_i_exp=[3 -4]
    ...
    save([savefolder,'sfm2_bsc_params_LMTKCP_GNTV_lambda_',num2str(lambda_i),'_new_',num2str(c),'.mat'], ...
         'params_all_reg','-v7.3');
    fprintf('\nSaved: sfm2_bsc_params_LMTKCP_GNTV_lambda_%g_new_%g.mat\n', lambda_i,c);
end
end