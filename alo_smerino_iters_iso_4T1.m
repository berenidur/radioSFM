...
%% === Load data ===
load('data/bscdata4T1CP.mat'); % contains struct bscdata4T1CP.(cpName).(scanName)
load('data/bsc_params_4T1CP.mat','params_all'); % your existing parameter maps
addpath('utils/');
...
for lambda_i_exp=[5 4 3 -4]
    ...
    save([savefolder,'bsc_params_4T1CP_GNTV_lambda_',num2str(lambda_i),'.mat'], ...
         'params_all_reg','-v7.3');
    fprintf('\nSaved: bsc_params_4T1CP_GNTV_lambda_%g.mat\n', lambda_i);
end
