function[Params]=sfm1_inversion_BSC_SFM_Neldermead_sansLog_Fc(freq,data,nb_xini)
...
[x,fvalmin,exitflag]=sfm1_F_InversionSFMTroisParam_NelderMead_Fc(connu,nb_xini);
% Vs=(4/3)*pi*(x(1))^3;
...
Params=[a1 phi1 gammaZ1 CdB R_Neldermead fvalmin exitflag];
